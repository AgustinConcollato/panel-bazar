...
export const MoneyReceiveIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props} fill="none">
    ...
    <path d="M21.4883 2.49292L17.3125 6.67112M16.4883 3.01468L16.6065 6.10617C16.6065 6.83481 17.0416 7.2888 17.8341 7.34606L20.9581 7.49292" stroke="#currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
  </svg>
)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  {...props} fill="none">
    ...
    <path d="M12 21H18" stroke="#currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
    <path d="M14.5 5.5L18.5 9.5" stroke="#currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
</svg>
)
